...
#Keys to Connecto on SQL SERVER
connectionBI = pyodbc.connect('DRIVER='+ driverBI+';SERVER='+serverBI+';DATABASE='+databaseBI+';UID='+userBI+';PWD='+passwBI)
...
#Insert data from Magento in SQL SERVER
